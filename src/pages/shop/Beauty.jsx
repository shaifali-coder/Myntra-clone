 ...
 <>    
    <div className="top-breadcrumb-container">
      <p className="breadcrumb-text">
        Home <span>/</span> <span className="current">Personal Care</span>
      </p>
...
<div className="filter-dropdown">
  <div
    ...
    onClick={() => setOpenBundles(!openBundles)}
  >
    <span>Bundles</span>
    <span className={`dropdown-arrow ${openBundles ? "open" : ""}`}></span>
  </div>

  {openBundles && (
    <div className="dropdown-menu bundles-row">
...
<div className="filter-dropdown">
  ...
  >
    ...
    <span className={`dropdown-arrow ${openCountries ? "open" : ""}`}></span>
  </div>
...
<div className="filter-dropdown">
  ...
  >
    <span>Size</span>
    <span className={`dropdown-arrow ${openSize ? "open" : ""}`}></span>
  </div>
  ...
  onClick={() =>
    navigate(`/products/${product.id}`, { state: { product: p } })
  }
